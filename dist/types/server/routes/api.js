...
import { keys, defaultUserProfile, applyStreak, currentIsoWeek } from '../core/storage';
...
api.post('/submit-cipher', async (c) => {
    const { emojis, answer } = await c.req.json();
...
api.get('/leaderboard', async (c) => {
    ...
    return c.json({ type: 'leaderboard', window, entries, viewerRank: null });
});
