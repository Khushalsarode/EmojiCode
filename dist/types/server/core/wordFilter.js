...
export const containsSevere = (text) => SEVERE_DENYLIST.some((p) => p.test(text));
export const containsProfanity = (text) => PROFANITY_DENYLIST.some((p) => p.test(text)) || containsSevere(text);
