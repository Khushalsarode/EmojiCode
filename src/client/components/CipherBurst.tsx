...
export const CipherBurst = ({ emojis, xpAwarded, firstCrack, onDone }: Props) => {
  ...
  return <div ref={containerRef} className="pointer-events-none fixed inset-0 z-[100]" aria-hidden="true" />;
};
