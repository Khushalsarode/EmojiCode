// Single source of truth for every button's look — variant/size here, not
// re-invented per screen. This is what keeps the whole app "one theme."
...
const VARIANT_CLASSES: Record<Variant, string> = {
  ...
  outline:
    'border-2 border-gray-300 dark:border-gray-600 text-gray-800 dark:text-gray-100 hover:border-[var(--color-primary)] hover:-translate-y-0.5',
